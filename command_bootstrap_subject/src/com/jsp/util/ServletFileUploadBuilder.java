...
public class ServletFileUploadBuilder {
	...
	public static ServletFileUpload build(int MEMORY_THRESHOLD, //빌더를 만들기 위한 사이즈 물을 담기 위한 바가지(캐쉬같은 성격)
										  int MAX_FILE_SIZE,
		...
		// 임시 저장 위치 결정
		factory.setRepository(new File(System.getProperty("java.io.tmpdir"))); //자바의 임시 경로 java.io.tmpdir
