    		  ...
    		  <div class="row">
	             <div class="col-sm-12">	
					...
					<c:forEach items="${noticeList }" var="notice">
						<tr style="font-size:0.85em; cursor:pointer;" onclick="OpenWindow('detail.do?nno=${notice.nno}', '상세정보', '800', '700');" >
							<td>${notice.nno }</td>
							
							<td id="boardTitle">${notice.title }</td>
							...
							<td><span class="badge bg-pink">${notice.viewcnt }</span></td>
		               	</tr>
					</c:forEach>
		            </table>
    		     </div> <!-- col-sm-12 -->
